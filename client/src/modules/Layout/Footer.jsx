...
import { Facebook, Linkedin, Twitter, ChevronRight, Instagram, Mail, Phone, MapPin } from "lucide-react";
...
const Footer = () => {
  ...
  // This ensures footer links scroll smoothly like the header links
        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            <div className="flex items-center gap-2">
              {/* Use handleScroll on Logo too if you want it to scroll to top */}
              <a href="#home" onClick={(e) => handleScroll(e, "#home")}>
                <img src={logo} alt="Universite Logo" className="h-10 w-auto" />
              </a>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed max-w-sm">
              We guide students toward their dream education with expert counseling and personalized university selection.
            </p>
            ...
            <div className="flex gap-4 pt-2">
              {[Instagram].map((Icon, index) => (
                <motion.a
                  key={index}
                  href="https://www.instagram.com/edu_consultants?igsh=MTRnMzJzeHJhenB4aA==" target="_blank"
                  whileHover={{ scale: 1.1, color: "#ef4444" }} // Red accent on hover
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-4 text-gray-300">
              {navLinks.map((link, index) => (
                ...
                >
                  <ChevronRight size={16} className="text-red-600 group-hover:text-white transition-colors" />
                  <a 
                    href={link.href} 
                    onClick={(e) => handleScroll(e, link.href)} // Attached Smooth Scroll here
            ...
            <div className="space-y-6 text-gray-300 text-sm">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <a href="tel:8015359971" className="hover:text-red-500 transition-colors">
                    +91 80153 59971
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <a href="mailto:educonsultants1994@gmail.com" className="hover:text-red-500 transition-colors">
                    educonsultants1994@gmail.com
                  </a>
                </div>
              </div>
            </div>
